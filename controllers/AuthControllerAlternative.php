...
require_once 'includes/AlternativeMailer.php';

class AuthControllerAlternative {
    private $usuario;
    ...
    public function __construct() {
        ...
        $this->mailer = new AlternativeMailer();
    ...
    public function authenticate() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($user && password_verify($clave, $user['clave'])) {
                // SIEMPRE generar y enviar código de verificación para login
    ...
    public function procesarVerificacion() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($verificacion) {
                ...
                if ($tipo === 'registro') {
                    // Para registro, marcar correo como verificado y redirigir al login
                    ...
                    // Para login, iniciar sesión directamente (sin marcar como verificado)
